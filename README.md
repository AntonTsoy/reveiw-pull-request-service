...
- Так как вы уже предоставили готовую OpenAPI спецификацию, я решил, для полного соответствия этой схеме стоит использовать инструменты для генерации кода сервера. Я выбрал популярный `oapi-codegen`.
...
- Использовал популярный Golden конфиг для `golangci-lint`.
